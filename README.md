...
### Get microphone innput gain value
```csharp
using UnityEngine;
...
public class MicInput : MonoBehaviour
{
    ...
    AudioClip _clipRecord = null; //Fix that works in Unity 2019.4.10f1
    // AudioClip _clipRecord = new AudioClip(); //Was in original script
